...
namespace Andrea_XQ
{
    public static class Main
    {
        ...
        public static int Event(string robotQq, int eventType, int extraType, string fromGroup, string fromQq, string targetQq, string content, string index, string msgid, string udpmsg, string unix, int p)
        {
            try
            {
                if (!long.TryParse(fromQq, out long fromQqInt64))
                {
                    File.AppendAllText(@"Andrea\Other\Convert", $"\n\nfromQQ {fromQq}");
                    return 1;
                }

                if (!long.TryParse(fromGroup, out long fromGroupInt64))
                {
                    File.AppendAllText(@"Andrea\Other\Convert", $"\n\nfromGroup {fromGroup}");
                    return 1;
                }
    ...
    public class Xqdll
    {
        ...
        public static extern IntPtr WithdrawMsg(byte[] autoid, string robotQq, string group, string messageNumber, string messageId);
        ...
        public static extern IntPtr SendMsgEX(byte[] autoid, string robotQq, int messageType, string group, string qq, string message, int bubbleId, bool anonymous);
        ...
        public static extern IntPtr SendMsgEX_V2(byte[] autoid, string robotQq, int messageType, string group, string qq, string message, int bubbleId, bool anonymous, string jsonMessage);
        ...
        public static extern IntPtr WithdrawMsgEX(byte[] autoid, string robotQq, int withdrawType, string group, string qq, string messageNumber, string messageId, string messageTime);
